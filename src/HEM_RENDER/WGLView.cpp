...
void CWGLView::BeginWGL()
{
	VERIFY(wglMakeCurrent(m_hDC, m_hRC));
}

void CWGLView::EndWGL()
{
	VERIFY(wglMakeCurrent(NULL, NULL));
}

void CWGLView::SwapBuffers()
{
	::SwapBuffers(m_hDC);
}

void CWGLView::CreateWGL()
{
...
void CWGLView::GLInitialPalette()
{
...
BOOL CWGLView::OnEraseBkgnd(CDC*)
{
	return TRUE;
}

BOOL CWGLView::OnQueryNewPalette()
{
...
void CWGLView::OnPaletteChanged(CWnd* pFocusWnd)
{
